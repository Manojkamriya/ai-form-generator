      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
          ...
          <div className="px-8 py-6 text-center" style={{ backgroundImage: 'linear-gradient(to right, rgb(226, 52, 43) 0%, rgb(255, 106, 28) 100%)' }}>
            ...
            <h2 className="text-2xl font-bold text-white">Join FormCraft AI</h2>
            <p className="mt-2 text-white/90">
              Get started and build incredible forms
            </p>
          </div>
          ...
          <div className="px-8 py-8">
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600">
                Have an account?{' '}
                <Link href="/login" className="font-semibold transition-colors duration-200" style={{ color: 'rgb(226, 52, 43)' }}>
                  Log in now
                </Link>
              </p>
            </div>
